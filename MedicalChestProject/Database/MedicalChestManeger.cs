...
namespace MedicalChestProject
{
    public class MedicalChestManeger : DatabaseManeger<MedicalChestManeger,MedicalChest, MySqlDataProvider, MySqlConnection>
    {
        ...
        public Diseases Diseases { get; protected set; }
        ...
        protected override void InitTableManegers()
        {
            ...
            Loggers.Add(Diseases);

            SingUpForPublisher(new ErrorMessageLogger<string>[] { Users, Drugs, Storages, AppTypes, DrugDiseases, Diseases });
        }
